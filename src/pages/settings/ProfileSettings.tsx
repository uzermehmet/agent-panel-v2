...
const ProfileSettings: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-gray-900 md:text-2xl">Profil Ayarları</h1>
        <p className="text-gray-600 mt-1">Hesap bilgilerinizi güncelleyin</p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-6 bg-white border border-gray-200 rounded-lg shadow-sm">
